...
*/
(function (c) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs", "datatables.net-editor"], function (a) {
        return c(a, window, document)
    }) : "object" === typeof exports ? module.exports = function (a, d) {
        a || (a = window);
        if (!d || !d.fn.dataTable) d = require("datatables.net-bs")(a, d).$;
    ...
    e.create.title = "<h3>" + e.create.title + "</h3>";
    e.edit.title = "<h3>" + e.edit.title + "</h3>";
    e.remove.title = "<h3>" + e.remove.title + "</h3>";
    ...
    a.Editor.display.bootstrap = c.extend(!0, {}, a.Editor.models.displayController, {
        init: function (a) {
            ...
            a.on("open.dtebs", function (b, a) {
                (a === "inline" || a === "bubble") &&
                c("div.DTE input[type=text], div.DTE select, div.DTE textarea").addClass("form-control")
            });
            return b
        },
        open: function (a, e, d) {
            if (b._shown) d && d();
                ...
                a.children().detach();
                a.append(e);
                c("div.modal-header", e).prepend(b._dom.close);
                ...
                c("input:not([type=checkbox]):not([type=radio]), select, textarea",
                    b._dom.content).addClass("form-control")
            }
        },
        close: function (a, d) {
            if (b._shown) {
