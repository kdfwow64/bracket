$(document).ready(function () {
    ...
    function getBlockedUsersList(page) {
        $.ajax({
            url: 'blocked-user-list-ajax?page=' + page,
            cache: false,
            processData: false,
            dataType: "json",
                ...
                if (confirmdata.data.length == 0) {
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        list_html += '<tr>\
                                        ...
                                        <td><a href="blocked-user/' + confirmdata.data[i].blocked_user_id + '">' + confirmdata.data[i].total + ' dater(s)</a></td>\
                                    </tr>';
                    }
                }
    ...
    /* Get list of blocked by users on page load */
    ...
    function getBlockedbyUsersList(page, userid) {
        $.ajax({
            url: '../blockedby-user-list-ajax?page=' + page + '&id=' + userid,
            cache: false,
            processData: false,
            dataType: "json",
            contentType: "application/json",
                ...
                if (confirmdata.data.length == 0) {
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        list_html += '<tr>\
                                        ...
                                        <td>' + finaldate + '</td>\
                                        <td class="word-break-width">' + confirmdata.data[i].reason + '</td>\
                                    </tr>';
                    }
                }
                $("#users-list").html(list_html);
    ...
    function blockeduserListBySearch(from_date, to_date, userid, page) {
        $.ajax({
            url: '../blocked-user-search-list?page=' + page,
            cache: false,
            processData: false,
            dataType: "json",
            contentType: "application/json",
